...
where record_bs_id=NEW.record_bs_id AND month_id=(SELECT MONTH(NEW.attendance_date) AS 'month'
 FROM attendance WHERE record_bs_id=NEW.record_bs_id AND attendance_date=NEW.attendance_date);
...
CREATE TABLE `users` (
  ...
  `image_path` varchar(45) NOT NULL default '',
  `register_date` date NOT NULL,
  `gender_id` int(10) unsigned NOT NULL,
  `religion_id` int(10) unsigned NOT NULL,
  `present_address` varchar(45) NOT NULL default '',
  `permanent_address` varchar(45) NOT NULL default '',
...
INSERT INTO `users` (`user_id`,`role_id`,`f_name`,`l_name`,`email`,`user_name`,`user_password`,`contact_number`,`image_path`,`register_date`,`gender_id`,`religion_id`,`present_address`,`permanent_address`) VALUES 
 (2,1,'islam','afsana','jkh','jkh','lk','9808','iou','2018-07-07',2,1,'Dhaka','Foridpur'),
 (3,1,'Salam','Abdus','jkh','jkh','lk','9808','iou','2018-07-07',1,1,'iuyi','uyoi'),
 (4,2,'Shikdar','Rubel','jkh','jkh','lk','9808','iou','2018-07-08',1,1,'iuyi','uyoi'),
 (5,4,'Begum','Sofia','jkh','jkh','lk','9808','iou','2018-07-08',2,1,'Dhaka','Cumilla');
