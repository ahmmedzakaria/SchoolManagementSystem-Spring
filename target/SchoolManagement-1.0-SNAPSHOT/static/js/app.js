...
app.run(function ($rootScope) {
    $rootScope.user;
    $rootScope.displayAlert = function (flag,msg,title,className) {
        
        if(flag === true && className!== undefined){
            console.log('Javascript function called with argument ' + flag);
            birdAlert.notify({
		msg: msg, 
		title: title, 
		className: className
    ...
    $rootScope.successAllert=function(msg){
        $rootScope.displayAlert(true,msg,"Success","success");
    };
    
    $rootScope.errorAllert=function(msg){
        $rootScope.displayAlert(true,msg,"Error","error");
    };
    
    $rootScope.infoAllert=function(msg){
        $rootScope.displayAlert(true,msg,"Info","info");
    };
    
    $rootScope.warningAllert=function(msg){
        $rootScope.displayAlert(true,msg,"Warning","warning");
    };
    
//    $rootScope.showDeleteDialog = function(confirmed) {
