...
INSERT INTO `attendance` (`attendance_id`,`record_bs_id`,`attendance_status`,`attendance_date`) VALUES 
 (1,1,1,'2018-01-01'),
 (2,1,1,'2018-01-02'),
 (3,1,0,'2018-01-03'),
 (4,1,1,'2018-01-01'),
...
where record_bs_id=NEW.record_bs_id AND month_id=(SELECT(MONTH(NEW.attendance_date)));
...
CREATE DEFINER = `root`@`localhost` TRIGGER `attendance_before_update` BEFORE UPDATE ON `attendance` FOR EACH ROW BEGIN
IF NEW.attendance_status=1 And old.attendance_status=0 THEN
 
    UPDATE db_school.attendance_report SET total_presents=total_presents+1 AND total_absents=total_absents-1
    where record_bs_id=NEW.record_bs_id AND month_id=(SELECT MONTH(NEW.attendance_date));

ELSEIF NEW.attendance_status=0 AND old.attendance_status=1 THEN

    UPDATE db_school.attendance_report SET total_absents=total_absents+1 AND total_presents=total_presents-1
    where record_bs_id=NEW.record_bs_id AND month_id=(SELECT(NEW.attendance_date));
...
INSERT INTO `student_record_bs` (`record_bs_id`,`class_id`,`group_id`,`section_id`,`session_id`,`user_id`,`roll_number`,`record_date`) VALUES 
 (1,6,1,1,1,5,1,'2018-01-01'),
 (2,6,1,1,1,12,2,'2018-07-14'),
 (3,6,1,1,1,13,2,'2018-07-14'),
 (4,6,1,1,1,14,2,'2018-07-14'),
 (5,6,1,1,1,15,2,'2018-07-14'),
 (6,6,1,1,1,16,2,'2018-07-15'),
 (7,6,1,1,1,17,2,'2018-07-15');
...
INSERT INTO `users` (`user_id`,`role_id`,`first_name`,`last_name`,`email`,`user_name`,`user_password`,`contact_number`,`image_path`,`register_date`,`gender_id`,`religion_id`,`present_address`,`permanent_address`,`dob`) VALUES 
 ...
 (5,4,'Begum','Sofia','jkh','jkh','lk','9808','iou','2018-07-08',2,1,'Dhaka','Cumilla','2018-07-07'),
 (7,4,'Rubel','Mia','skdflsj','rubel','lksd',NULL,NULL,'2018-07-12',1,1,NULL,NULL,'2018-07-12'),
 (12,4,'qwert','poiu','dui','ios','lkjh',NULL,NULL,'2018-07-14',1,1,NULL,NULL,'2018-07-14'),
 (13,4,'dsfoiw','uiweru','jkdf','cmvnj','jkdsf',NULL,NULL,'2018-07-14',1,1,NULL,NULL,'2018-07-14'),
 (14,4,'lskd','lksdfiosa','ksdf','oiwe','lksdw',NULL,NULL,'2018-07-14',1,1,NULL,NULL,'2018-07-14'),
 (15,4,'s','lsdoi',',sd','oidsfqoi','lksd',NULL,NULL,'2018-07-14',1,1,NULL,NULL,'2018-07-14'),
 (16,4,'iuewj','isudw','jsd','iuwej','kjsd',NULL,NULL,'2018-07-15',1,1,NULL,NULL,'2018-07-15'),
 (17,4,'lksdioq','lskdf','lksdf','klsdf','klsdf',NULL,NULL,'2018-07-15',1,1,NULL,NULL,'2018-07-15');
