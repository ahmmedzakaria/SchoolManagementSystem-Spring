    ...
    <body ng-app="myApp">
        <div ng-controller="StudentController as studentCtrl">
            ...
            <form name="usersForm" method="POST">
                <table>
                    <tr><td colspan="2">
                            ...
                            <div ng-if="studentCtrl.flag == 'edit'">
                                <h3> Update Users for ID: {{ studentCtrl.users.userId}} </h3> 
                            </div> </td>
                    </tr>
                    <tr>
                        <td>First Name: </td> <td><input type="text" name="firstName" ng-model="studentCtrl.users.firstName" required/> 
                            <span ng-show="usersForm.firstName.$error.required" class="msg-val">Name is required.</span> </td>
                    </tr>
                    <tr>
                        <td>Last Name </td> <td> <input type="text" name="lastName" ng-model="studentCtrl.users.lastName" required/> 
                            <span ng-show="usersForm.lastName.$error.required" class="msg-val">Location is required.</span> </td>
                    </tr>
                    <tr>
                        <td>User Name </td> <td> <input type="text" name="phone" ng-model="studentCtrl.users.userName" required/> 
                            <span ng-show="usersForm.phone.$error.required" class="msg-val">Phone No is required.</span> </td>
                    </tr>
                    <tr>
                        <td>Password</td> <td> <input type="text" name="mobile" ng-model="studentCtrl.users.userPassword" required/> 
                            <span ng-show="usersForm.mobile.$error.required" class="msg-val">Mobile No is required.</span> </td>
                    </tr>
                    <tr>
                        <td>Email </td> <td> <input type="text" name="email" ng-model="studentCtrl.users.email" required/> 
                    ...
                    <tr><td colspan="2">
                            <div ng-if="personCtrl.flag != 'edit'">
                                <input  type="submit" ng-click="studentCtrl.addUsers()" value="Add Users"/> 
                                <input type="button" ng-click="studentCtrl.reset()" value="Reset"/>
                            </div>
                            <div ng-if="studentCtrl.flag == 'edit'">
                                <input  type="submit" ng-click="studentCtrl.updateUsersDetail()" value="Update Users"/> 	
            ...
            <table>
                ...
                <tr ng-repeat="row in studentCtrl.userss">
                    <td><span ng-bind="row.userId"></span></td>
                    <td><span ng-bind="row.firstName"></span></td>
                    <td><span ng-bind="row.lastName"></span></td>
                    <td>
                        <input type="button" ng-click="studentCtrl.deleteUsers(row.userId)" value="Delete"/>
                        <input type="button" ng-click="studentCtrl.editUsers(row.userId)" value="Edit"/>
                        <span ng-if="studentCtrl.flag == 'updated' && row.userId == studentCtrl.updatedId" class="msg-success">Users successfully updated.</span> </td> 
                </tr>	
            </table>
        </div>
        ...
        <script src="${pageContext.request.contextPath}/static/js/controller/student_controller.js" type="text/javascript"></script>
